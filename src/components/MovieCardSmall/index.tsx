  ...
  return (
    ...
    >
      ...
      >
        ...
        <LazyLoadImage
          key={data?.id}
          src={`${imagePlaceholder ? "/images/logo.svg" : data?.poster_path !== null && data?.poster_path !== undefined ? process.env.NEXT_PUBLIC_TMBD_IMAGE_URL?.replace("/original", "/w600_and_h900_bestv2") + data?.poster_path : "/images/logo.svg"}`}
          height="100%"
          width="100%"
